...
@XPathFunctionGroup(category = "Custom Functions Local Cache", prefix = "cf_cache", namespace = "http://com.tibcopsg.tibcobw.customfunctions.localcache", helpText = "Custom defined function for local cache")
...
*/
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "alias", optional = false, optionalValue = ""),
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "alias", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "Separation", optional = false, optionalValue = "") })
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "alias", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "SeparationK_V", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "SeparationKV_KV", optional = false, optionalValue = "") })
...
//		Enumeration<String> keysValues = aliasList.keys();
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "alias", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "key", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "defaultValue", optional = false, optionalValue = "") })
	public static String getValueOrDefault( String alias, String key, String defaultValue)
	{
   	...
   	@XPathFunction(helpText = "", parameters = {
			...
			@XPathFunctionParameter(name = "key", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "defaultValue", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "errorString", optional = false, optionalValue = "") })
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "alias", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "key", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "value", optional = false, optionalValue = "") })
