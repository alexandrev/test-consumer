...
@XPathFunctionGroup(category = "Custom Functions String", prefix = "cf_string", namespace = "http://com.tibcopsg.tibcobw.customfunctions.string", helpText = "Custom defined function for String")
public class FString
{
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "findRegexp", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "replaceRegexp", optional = false, optionalValue = ""),
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "expression", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "encoding", optional = false, optionalValue = "") })
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "srcString", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "searchString", optional = false, optionalValue = "") })
	...
	@XPathFunction(helpText = "", parameters = {
			@XPathFunctionParameter(name = "srcString", optional = false, optionalValue = ""),
			@XPathFunctionParameter(name = "srcFormat", optional = false, optionalValue = "") })
